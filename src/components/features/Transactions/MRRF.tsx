...
const MRRF: React.FC = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        addTransaction({
            ...
            mrrfNumber: formData.mrrfNumber,
            jobOrderNumber: formData.jobOrderNumber,
            pic: formData.pic,
            requestQty: Number(formData.quantity), // Mapping main qty to requestQty
    ...
    return (
        <div className={styles.pageContainer}>
            <div className={styles.header}>
                <h1 className={styles.title}>Material Request (MRRF)</h1>
            </div>
                ...
                <Card title="2. Request Details">
                    <form onSubmit={handleSubmit} className={styles.form}>
                        ...
                        <div className={styles.formActions}>
                            <Button type="submit" variant="danger" disabled={!selectedItemId || formData.quantity <= 0}>
